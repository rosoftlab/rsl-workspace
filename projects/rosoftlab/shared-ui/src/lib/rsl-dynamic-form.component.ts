...
import {
  MODEL_SERVICE,
  MODEL_TOKEN,
  RSL_FORM_IMPLEMENTATIONS_TOKEN
} from '@rosoftlab/core';
...
export class RSLDynamicComponent implements OnInit {
  ...
  private formMap = inject(RSL_FORM_IMPLEMENTATIONS_TOKEN);
  ...
  ngOnInit(): void {
    ...
    this.selectedComponent = this.formMap[implKey];

...
import { IDialogService } from '@rosoftlab/core';
import { Observable } from 'rxjs';

@Injectable({
  providedIn: 'root'
})
export class MaterialDialogService implements IDialogService {
  constructor(public translate: TranslateService, private dialogService: DialogService, private notificationService: NotificationService) {}
  public state: NotificationSettings = {
    content: this.translate.instant('Your data has been saved.'),
